...
export function PawiTip({ tip, trivia, image = "/pawi-turtle.png" }: PawiTipProps) {
  return (
    <div className="mx-5 mb-5 mt-2 flex items-start gap-4 rounded-3xl bg-primary/10 p-5 shadow-sm">
      ...
      <div className="relative mt-1 flex-1 rounded-2xl rounded-tl-none bg-card p-4 text-sm font-medium text-foreground shadow-sm">
        <div
          className="absolute -left-2 top-0 h-4 w-4 bg-card"
